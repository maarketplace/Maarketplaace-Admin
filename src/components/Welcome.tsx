...
const Welcome = () => {
  return (
    <motion.div
      ...
      className="w-full h-[45rem] flex justify-center items-center flex-col"
    >
      <motion.div
        initial={{ y: -50, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
        transition={{ delay: 0.2, duration: 0.5 }}
        className="w-full h-[20%] flex justify-center items-center flex-col"
      >
      ...
      <motion.div
        ...
        className="w-[40%] h-[70%] bg-white shadow-lg flex justify-around items-center flex-col max-md:w-[90%]"
      >
        <motion.div
        ...
        >
          <img src={welcomeimg} alt="" className="size-[25rem]" />
        </motion.div>
        <motion.div
